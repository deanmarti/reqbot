...
$max_file_size = 1024*200000; 
//$path = "D:\home\site\wwwroot"; // Upload directory
$count = 0;
...
{     
	    ...
	    if ($_FILES['files']['error'][$f] == 0) {	           
			...
			elseif( ! in_array(pathinfo(strtolower($name), PATHINFO_EXTENSION), $valid_formats) ){
	           ...
	           // if(move_uploaded_file($_FILES["files"]["tmp_name"][$f], $path."netreqs.csv")) {
	           	 if(move_uploaded_file($_FILES["files"]["tmp_name"][$f], "netreqs.csv")) {
